        ...
        <pane size="84">
          <el-col>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="身份证号" align="center" key="idCard" prop="idCard" v-if="columns[5].visible" width="180" :show-overflow-tooltip="true" />
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="身份证号" prop="idCard">
              <el-input v-model="form.idCard" placeholder="请输入身份证号码（用于H5移动端登录）" maxlength="18" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  methods: {
    ...
    handleFileSuccess(response, file, fileList) {
      ...
      this.$msgbox({
        title: '导入结果',
        message: h('div', {
          style: 'overflow: auto;overflow-x: hidden;max-height: 70vh;padding: 10px 20px 0;white-space: pre-wrap;'
        }, response.msg || ''),
        confirmButtonText: '确定'
      })
      this.getList()
