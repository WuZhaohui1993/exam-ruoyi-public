...
### 管理首页：考试、题库、用户与近期考试概览

![管理首页：考试、题库、用户与近期考试概览](docs/assets/exam-home.png)

### 题库管理：题型、难度、分值、导入与预览

![题库管理：题型、难度、分值、导入与预览](docs/assets/exam-questions.png)

### 试卷管理：固定试卷、题目数量、考试时长与发布状态

![试卷管理：固定试卷、题目数量、考试时长与发布状态](docs/assets/exam-paper-list.png)

### 试题预览：选项、正确答案、解析与标签

![试题预览：选项、正确答案、解析与标签](docs/assets/preview.webp)
