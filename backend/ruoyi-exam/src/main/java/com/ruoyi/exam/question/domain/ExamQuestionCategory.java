...
public class ExamQuestionCategory extends BaseEntity
{
    ...
    /** 子分类 */
    private java.util.List<ExamQuestionCategory> children = new java.util.ArrayList<ExamQuestionCategory>();
    ...
    public java.util.List<ExamQuestionCategory> getChildren()
    {
        return children;
    }

    public void setChildren(java.util.List<ExamQuestionCategory> children)
    {
